...
export default function TermsPage() {
  ...
  <h1 className="text-3xl font-bold text-slateText  mb-6">Terms & Conditions</h1>
  ...
  <h2 className="text-lg font-bold text-slateText  mt-6">Account Registration</h2>
  ...
  <h2 className="text-lg font-bold text-slateText  mt-6">Products & Pricing</h2>
  ...
  <h2 className="text-lg font-bold text-slateText  mt-6">Orders & Payments</h2>
  ...
  <h2 className="text-lg font-bold text-slateText  mt-6">Shipping & Delivery</h2>
  ...
  <h2 className="text-lg font-bold text-slateText  mt-6">Returns & Refunds</h2>
