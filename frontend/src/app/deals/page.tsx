  ...
  return (
    <div>
      ...
      <div className="container-custom py-8 lg:py-12">
        ...
        <h2 className="text-2xl font-bold text-slateText dark:text-white mb-6">
        ...
        {deals.length > 0 ? (
          ...
          <div className="text-center py-20 bg-white dark:bg-navy-200 border border-lineBorder dark:border-navy-50 rounded-2xl">
            ...
            <h3 className="text-xl font-bold text-slateText dark:text-white mb-2">No deals right now</h3>
