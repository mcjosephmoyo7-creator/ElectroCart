...
export default function SuccessContent() {
  ...
  return (
    <div className="container-custom py-16 lg:py-24">
      <div className="max-w-xl mx-auto text-center bg-white dark:bg-navy-200 border border-lineBorder dark:border-navy-50 rounded-3xl p-10 lg:p-14 shadow-card">
        ...
        <h1 className="text-3xl lg:text-4xl font-bold text-slateText dark:text-white mb-3">
          Order Confirmed!
        </h1>
        ...
        <div className="bg-body dark:bg-navy-100 border border-lineBorder dark:border-navy-100 rounded-2xl p-6 mb-6">
