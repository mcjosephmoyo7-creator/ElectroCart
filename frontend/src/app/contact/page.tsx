...
export default function ContactPage() {
  ...
  <h2 className="text-xl font-bold text-slateText  mb-6">Send Us a Message</h2>
  ...
  <div key={label} className="bg-white  border border-lineBorder  rounded-2xl p-5 flex items-center gap-4 shadow-card">
  ...
  <p className="font-semibold text-slateText ">{value}</p>
  </div>
  </div>
  ))}
