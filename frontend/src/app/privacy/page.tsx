...
export default function PrivacyPage() {
  ...
  <h1 className="text-3xl font-bold text-slateText  mb-6">Privacy Policy</h1>
  ...
  <h2 className="text-lg font-bold text-slateText  mt-6">Information We Collect</h2>
  ...
  <h2 className="text-lg font-bold text-slateText  mt-6">How We Use Your Information</h2>
  ...
  <h2 className="text-lg font-bold text-slateText  mt-6">Cookies</h2>
  ...
  <h2 className="text-lg font-bold text-slateText  mt-6">Data Security</h2>
  ...
  <h2 className="text-lg font-bold text-slateText  mt-6">Third-Party Services</h2>
  ...
  <h2 className="text-lg font-bold text-slateText  mt-6">Contact Us</h2>
