    ...
    <div>
      ...
      <div className="container-custom py-12 lg:py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <h2 className="text-3xl font-bold text-slateText dark:text-white mb-5">We bring the best tech, closer to you</h2>
        ...
        <div className="mt-16 grid grid-cols-2 lg:grid-cols-4 gap-4">
          {stats.map((stat) => (
            <div key={stat.label} className="bg-white dark:bg-navy-200 border border-lineBorder dark:border-navy-50 rounded-2xl p-8 text-center shadow-card">
        ...
        {/* Values */}
        <div className="mt-16">
          <h2 className="text-3xl font-bold text-slateText dark:text-white text-center mb-10">Why Shop With Us</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {values.map(({ icon: Icon, title, desc }) => (
              <div key={title} className="bg-white dark:bg-navy-200 border border-lineBorder dark:border-navy-50 rounded-2xl p-6 shadow-card hover:shadow-card-hover hover:-translate-y-1 transition-all">
                <span className="w-12 h-12 bg-primary/10 rounded-xl flex items-center justify-center mb-4">
                  <Icon className="w-6 h-6 text-primary" />
                </span>
                <h3 className="font-bold text-slateText dark:text-white mb-2">{title}</h3>
