...
export default function ProductCard({ product }: ProductCardProps) {
  ...
  return (
  <div
  className="group relative bg-white  rounded-xl border border-lineBorder  shadow-card hover:shadow-card-hover hover:-translate-y-1 transition-all duration-300 overflow-hidden flex flex-col"
  ...
  className="w-full flex items-center justify-center gap-2 bg-white/95  backdrop-blur text-navy  py-2.5 rounded-lg text-sm font-semibold shadow hover:bg-primary hover:text-white transition-colors"
  >
  ...
  className="absolute top-3 right-3 w-9 h-9 bg-white  rounded-full shadow flex items-center justify-center hover:scale-110 transition-transform"
  >
  {isWishlisted ? (
  ...
  <h3 className="font-semibold text-slateText  text-[15px] leading-snug line-clamp-2 hover:text-primary transition-colors">
  {product.name}
  </h3>
  </Link>
  ...
  <span className="text-lg font-bold text-slateText ">
