  ...
  return (
    <section className="container-custom py-12 lg:py-16">
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8">
        ...
        {/* Tabs */}
        <div className="flex items-center gap-1 bg-white dark:bg-navy-200 border border-lineBorder dark:border-navy-50 rounded-full p-1 w-fit">
          {tabs.map((tab) => (
            <button
              key={tab.key}
      ...
      {loading ? (
        ...
        <div className="rounded-2xl border border-lineBorder dark:border-navy-50 bg-white dark:bg-navy-200 p-10 text-center text-muted">
      ...
      <div className="text-center mt-10">
        <Link
          href="/shop"
          className="inline-flex items-center gap-2 bg-navy dark:bg-navy-50 text-white dark:text-white hover:bg-primary px-7 py-3 rounded-lg font-semibold transition-colors"
        >
