...
export default function CategoriesGrid() {
  ...
  className="group rounded-2xl border border-lineBorder  bg-white  p-5 text-center transition-all duration-300 hover:-translate-y-1.5 hover:shadow-card-hover hover:border-primary"
  style={{ backgroundColor: cat.pastel }}
  >
  <div className="w-16 h-16 mx-auto rounded-2xl bg-white/80  flex items-center justify-center mb-4 shadow-sm group-hover:scale-110 transition-transform duration-300">
