      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative w-full max-w-md max-h-[90vh] overflow-y-auto bg-white dark:bg-navy-200 border border-lineBorder dark:border-navy-50 rounded-2xl p-6 shadow-card"
          >
            <button
              type="button"
              onClick={close}
              className="absolute top-4 right-4 w-9 h-9 rounded-full flex items-center justify-center text-muted hover:bg-gray-100 dark:hover:bg-navy-100 hover:text-slateText transition-colors"
              aria-label="Close"
            >
  ...
  return (
    <div>
      <div className="text-center mb-6 pr-8">
        <h2 className="text-xl font-bold text-slateText dark:text-white">{title}</h2>
