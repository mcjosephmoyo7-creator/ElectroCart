    ...
    <div>
      <div className="space-y-2.5">
        <a
          ...
          className="w-full flex items-center justify-center gap-2.5 py-3 rounded-xl border border-lineBorder dark:border-navy-50 bg-white dark:bg-navy-200 text-slateText dark:text-white text-sm font-semibold hover:bg-gray-50 dark:hover:bg-navy-100 transition-colors"
        >
      ...
      <div className="flex items-center gap-3 my-5">
        <div className="flex-1 h-px bg-lineBorder dark:bg-navy-50" />
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        {isRegister && (
          <div>
            <label className="block text-sm font-semibold mb-1.5 text-slateText dark:text-white">
              Username
            </label>
            <input
              value={username}
